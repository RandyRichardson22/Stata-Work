...
/*drop if ceq == .*/
drop if missing(ceq)
*keep if !missing(ceq)- means the same thing as the thing above.
...
/*Estimate the ratio of ppent and at (use the type that records the variable with highest precision), create a label for this variable.*/
