...
scalar marketReturn = (indexW2020 / indexW1970)^(1/indexYears) - 1
...
forvalues i = -0.01(0.01)0.11 {

* Use CAPM

scalar marketReturn = `i'
scalar list marketReturn
...
forvalues j = 0(0.005)0.06 {

scalar growthInflation = `j'
scalar list growthInflation
* PV0cgp = CF1/(i-g)
