...
forvalues i=30(5)50 {
* No Hedging
scalar probability1 = `i' / 100
scalar probability2 = 1 - probability1
scalar expectedER = probability1 * expectedER1 + probability2 * expectedER2
scalar receivablesNoHedging`i' = receivablesForeign * expectedER
quietly log on
scalar list receivablesNoHedging`i'
quietly log off
...
scalar expectedERoptions = probability1 * expectedER1options ///
    + probability2 * expectedER2options - optionPremium
scalar receivablesOptions`i' = receivablesForeign * expectedERoptions
quietly log on
scalar list receivablesOptions`i'
quietly log off
}
quietly log close
